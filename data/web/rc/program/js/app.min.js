...
"_code=0x199")};this.log=function(a){this.env.devel_mode&&window.console&&console.log&&console.log(a)};this.command=function(a,b,d,e){var g,h,k,l=!1;!d||!d.blur||e&&rcube_event.is_keyboard(e)||d.blur();if(this.busy&&("reset-search"!=a||"search"!=this.last_command)&&!a.match(/^menu-/))return!1;if(d&&d.href&&0>String(d.href).indexOf("#")&&rcube_event.get_modifier(e))return!0;if(!this.commands[a])return this.is_framed()&&parent.rcmail.command(a,b),!1;if("mail"==this.task&&"compose"==this.env.action&&
!this.env.server_error&&"save-pref"!=a&&0>$.inArray(a,this.env.compose_commands)){if(!this.env.is_sent&&this.cmp_hash!=this.compose_field_hash()&&!confirm(this.get_label("notsentwarning")))return!1;this.remove_compose_data(this.env.compose_id);this.compose_skip_unsavedcheck=!0}this.last_command=a;if("function"===typeof this.command_handlers[a])return g=this.command_handlers[a](b,d,e),void 0!==g?g:d?!1:!0;if("string"===typeof this.command_handlers[a])return g=window[this.command_handlers[a]](b,d,e),
void 0!==g?g:d?!1:!0;this.triggerEvent("actionbefore",{props:b,action:a,originalEvent:e});g=this.triggerEvent("before"+a,b||e);if(void 0!==g){if(!1===g)return!1;b=g}g=void 0;switch(a){case "login":this.gui_objects.loginform&&this.gui_objects.loginform.submit();break;case "logout":case "mail":case "addressbook":case "settings":this.switch_task(a);break;case "about":this.redirect("?_task=settings&_action=about",!1);break;case "permaurl":if(d&&d.href&&d.target)return!0;this.env.permaurl&&(parent.location.href=
this.env.permaurl);break;case "extwin":if("compose"==this.env.action){if(e=this.gui_objects.messageform,h=this.open_window(""))this.save_compose_form_local(),this.compose_skip_unsavedcheck=!0,$("input[name='_action']",e).val("compose"),e.action=this.url("mail/compose",{_id:this.env.compose_id,_extwin:1}),e.target=h.name,e.submit()}else this.open_window(this.env.permaurl,!0);break;case "change-format":e=this.env.permaurl+"&_format="+b;"preview"==this.env.action&&(e=e.replace(/_action=show/,"_action=preview")+
...
(e._all="list"),this.open_compose_step(e);break;case "forward-attachment":case "forward-inline":case "forward":h=this.env.uid?[this.env.uid]:this.message_list?this.message_list.get_selection():[];if(h.length){e={_forward_uid:this.uids_to_list(h),_mbox:this.env.mailbox,_search:this.env.search_request};if("forward-attachment"==a||!b&&this.env.forward_attachment||1<h.length)e._attachment=1;this.open_compose_step(e)}break;case "print":if("addressbook"==this.task){if(h=this.contact_list.get_single_selection())e=
"&_action=print&_cid="+h,this.env.source&&(e+="&_source="+urlencode(this.env.source)),this.open_window(this.env.comm_path+e,!0,!0)}else if("get"==this.env.action&&!this.env.is_message)this.gui_objects.messagepartframe.contentWindow.print();else if(h=this.get_single_uid())e=this.url("print",this.params_from_uid(h,{_safe:this.env.safemode?1:0})),this.open_window(e,!0,!0)&&"show"!=this.env.action&&"get"!=this.env.action&&this.mark_message("read",h);break;case "viewsource":(h=this.get_single_uid())&&
...
g='<span id="flagicn'+x.id+'" class="'+g+'" title="'+l+'"></span>'):"attachment"==g?(l=this.get_label("withattachment"),g=d.attachmentClass?'<span class="'+d.attachmentClass+'" title="'+l+'"></span>':/application\/|multipart\/(m|signed)/.test(d.ctype)?'<span class="attachment" title="'+l+'"></span>':/multipart\/report/.test(d.ctype)?'<span class="report"></span>':"multipart/encrypted"==d.ctype||"application/pkcs7-mime"==d.ctype?'<span class="encrypted"></span>':"&nbsp;"):"status"==g?(l="",d.deleted?
(g="deleted",l=this.get_label("deleted")):d.seen?g=0<d.unread_children?"unreadchildren":"msgicon":(g="unread",l=this.get_label("unread")),g='<span id="statusicn'+x.id+'" class="'+g+m+'" title="'+l+'"></span>'):"threads"==g?g=p:"subject"==g?g=n+b[g]:"priority"==g?0<d.prio&&6>d.prio?(l=this.get_label("priority")+" "+d.prio,g='<span class="prio'+d.prio+'" title="'+l+'"></span>'):g="&nbsp;":g="folder"==g?'<span onmouseover="rcube_webmail.long_subject_title(this)">'+b[g]+"<span>":b[g],f.innerHTML=g,x.cols.push(f);
"widescreen"==this.env.layout&&(x=this.widescreen_message_row(x,a,t));q.insert_row(x,e);e&&this.env.pagesize&&q.rowcount>this.env.pagesize&&(a=q.get_last_row(),q.remove_row(a),q.clear_selection(a))};this.widescreen_message_row=function(a,b,d){var e=document.createElement("tr");e.id=a.id;e.uid=a.uid;e.className=a.className;a.style&&$.extend(e.style,a.style);$.each(this.env.widescreen_list_template,function(){if(f.env.threading||"threads"!=this.className){var b,d,k,l=document.createElement("td");this.className&&
(l.className=this.className);for(b=0;this.cells&&b<this.cells.length;b++)for(d=0;a.cols&&d<a.cols.length;d++)if(this.cells[b]==a.cols[d].className){d=a.cols[d];k=document.createElement("span");k.className=this.cells[b];"subject"==this.className&&"subject"!=k.className&&(k.className+=" skip-on-drag");d.innerHTML&&(k.innerHTML=d.innerHTML);l.appendChild(k);break}e.appendChild(l)}});this.env.threading&&d.depth&&($("td.subject",e).attr("style","padding-left:"+Math.min(90,15*d.depth)+"px !important"),
...
this.env.sort_order!=d)h=1,this.set_list_sorting(b,d);this.env.threading!=e&&(h=1,f._threads=e);g&&this.env.layout!=g&&(this.triggerEvent("layout-change",{old_layout:this.env.layout,new_layout:g}),h=1,this.env.layout=f._layout=g);if(a&&a.length){var l,m=[],n=this.env.listcols;for(e=0;e<n.length;e++)l=n[e],g=$.inArray(l,a),-1!=g&&(m.push(l),delete a[g]);for(e=0;e<a.length;e++)a[e]&&m.push(a[e]);m.join()!=n.join()&&(h=1,f._cols=m.join(","))}h&&this.list_mailbox("","",b+"_"+d,f)};this.show_message=function(a,
b,d){if(a){var e,g=window;a=this.params_from_uid(a,{_caps:this.browser_capabilities()});d&&(e=this.get_frame_window(this.env.contentframe))&&(g=e,a._framed=1);b&&(a._safe=1);this.env.search_request&&(a._search=this.env.search_request);this.env.extwin&&(a._extwin=1);a=this.url(d?"preview":"show",a);d&&0<=String(g.location.href).indexOf(a)?this.show_contentframe(!0):d||!this.env.message_extwin||this.env.extwin?this.location_href(a,g,!0):this.open_window(a,!0)}};this.set_unread_message=function(a,b){var d=
this;d.message_list||(d=d.opener());!d&&window.parent&&(d=parent.rcmail);d&&d.message_list&&(!1===d.set_message(a,"unread",!1)&&d.set_message(a+"-"+b,"unread",!1),0<d.env.unread_counts[b]&&(--d.env.unread_counts[b],d.set_unread_count(b,d.env.unread_counts[b],"INBOX"==b&&!d.is_multifolder_listing())))};this.show_contentframe=function(a){var b,d,e=this.env.contentframe;if(b=this.get_frame_element(e))if(!a&&(d=this.get_frame_window(e)))0>d.location.href.indexOf(this.env.blankpage)&&(d.stop?d.stop():
d.document.execCommand("Stop"),d.location.href=this.env.blankpage);else if(!bw.safari&&!bw.konq)$(b)[a?"show":"hide"]();!a&&this.env.frame_lock&&this.set_busy(!1,null,this.env.frame_lock)};this.get_frame_element=function(a){var b;if(a&&(b=document.getElementById(a)))return b};this.get_frame_window=function(a){if((a=this.get_frame_element(a))&&a.name&&window.frames)return window.frames[a.name]};this.lock_frame=function(){this.env.frame_lock||((this.is_framed()?parent.rcmail:this).env.frame_lock=this.set_busy(!0,
"loading"))};this.list_page=function(a){"next"==a?a=this.env.current_page+1:"last"==a?a=this.env.pagecount:"prev"==a&&1<this.env.current_page?a=this.env.current_page-1:"first"==a&&1<this.env.current_page&&(a=1);0<a&&a<=this.env.pagecount&&(this.env.current_page=a,"addressbook"==this.task||this.contact_list?this.list_contacts(this.env.source,this.env.group,a):"mail"==this.task&&this.list_mailbox(this.env.mailbox,a))};this.checkmail=function(){var a=this.set_busy(!0,"checkingmail"),b=this.check_recent_params();
this.http_post("check-recent",b,a)};this.filter_mailbox=function(a){if(!this.filter_disabled){var b=this.set_busy(!0,"searching");this.clear_message_list();this.env.current_page=1;this.env.search_filter=a;this.http_request("search",this.search_params(!1,a),b)}};this.refresh_list=function(){this.list_mailbox(this.env.mailbox,this.env.current_page||1,null,{_clear:1},!0);this.message_list&&this.message_list.clear_selection()};this.list_mailbox=function(a,b,d,e,g){var h=window;"object"!=typeof e&&(e=
{});a||(a=this.env.mailbox?this.env.mailbox:"INBOX");d&&(e._sort=d);this.env.mailbox!=a?(b=1,this.env.current_page=b,this.env.search_scope="base",this.select_all_mode=!1,this.reset_search_filter()):this.env.search_request&&(e._search=this.env.search_request);if(!g){this.clear_message_list();if(a!=this.env.mailbox||a==this.env.mailbox&&!b&&!d)e._refresh=1;this.select_folder(a,"",!0);this.unmark_folder(a,"recent","",!0);this.env.mailbox=a}if(this.gui_objects.messagelist)this.list_mailbox_remote(a,b,
e);else{if(d=this.get_frame_window(this.env.contentframe))h=d,e._framed=1;this.env.uid&&(e._uid=this.env.uid);a&&(this.set_busy(!0,"loading"),e._mbox=a,b&&(e._page=b),this.location_href(e,h))}};this.clear_message_list=function(){this.env.messages={};this.show_contentframe(!1);this.message_list&&this.message_list.clear(!0)};this.list_mailbox_remote=function(a,b,d){var e=this.set_busy(!0,"loading");"object"!=typeof d&&(d={});d._mbox=a;b&&(d._page=b);this.message_list&&(this.message_list.dblclick_time=
...
this.init_threads=function(a,b){if(b&&b!=this.env.mailbox)return!1;for(var d=0,e=a.length;d<e;d++)this.add_tree_icons(a[d]);this.expand_threads()};this.add_tree_icons=function(a){var b,d,e,g,h=[],f=[],l,m=this.message_list.rows;for(l=a?m[a]?m[a].obj:null:this.message_list.tbody.firstChild;l;){if(1==l.nodeType&&(d=m[l.uid]))if(d.depth){for(b=h.length-1;0<=b&&!(e=h[b].length,e>d.depth?(g=e-d.depth,h[b][g]&2||(h[b][g]=h[b][g]?h[b][g]+2:2)):e==d.depth&&(h[b][0]&2||(h[b][0]+=2)),d.depth>e);b--);h.push(Array(d.depth));
h[h.length-1][0]=1;f.push(d.uid)}else{if(h.length){for(b in h)this.set_tree_icons(f[b],h[b]);h=[];f=[]}if(a&&l!=m[a].obj)break}l=l.nextSibling}if(h.length)for(b in h)this.set_tree_icons(f[b],h[b])};this.set_tree_icons=function(a,b){var d,e=[],g="",h=b.length;for(d=0;d<h;d++)2<b[d]?e.push({"class":"l3",width:15}):1<b[d]?e.push({"class":"l2",width:15}):0<b[d]?e.push({"class":"l1",width:15}):e.length&&!e[e.length-1]["class"]?e[e.length-1].width+=15:e.push({"class":null,width:15});for(d=e.length-1;0<=
d;d--)g=e[d]["class"]?g+('<div class="tree '+e[d]["class"]+'" />'):g+('<div style="width:'+e[d].width+'px" />');g&&$("#rcmtab"+this.html_identifier(a,!0)).html(g)};this.update_thread_root=function(a,b){if(this.env.threading){var d=this.message_list.find_root(a);if(a!=d){var e=this.message_list.rows[d];if("read"==b&&e.unread_children)e.unread_children--;else if("unread"==b&&e.has_children)e.unread_children=(e.unread_children||0)+1;else if("unflagged"==b&&e.flagged_children)e.flagged_children--;else if("flagged"==
b&&e.has_children)e.flagged_children=(e.flagged_children||0)+1;else return;this.set_message_icon(d);this.set_unread_children(d);this.set_flagged_children(d)}}};this.update_thread=function(a){if(!this.env.threading)return 0;var b,d,e=0,g=this.message_list.rows,h=g[a],k=g[a].depth,l=[];h.depth||e--;h.depth&&h.unread&&(d=this.message_list.find_root(a),g[d].unread_children--,this.set_unread_children(d));h.depth&&h.flagged&&(d=this.message_list.find_root(a),g[d].flagged_children--,this.set_flagged_children(d));
d=h.parent_uid;for(h=h.obj.nextSibling;h;){if(1==h.nodeType&&(b=g[h.uid])){if(!b.depth||b.depth<=k)break;b.depth--;$("#rcmtab"+b.id).width(15*b.depth).html("");b.depth?(b.depth==k&&(b.parent_uid=d),b.unread&&l.length&&l[l.length-1].unread_children++):(e++,b.parent_uid=0,b.has_children&&($("#"+b.id+" .leaf:first").attr("id","rcmexpando"+b.id).attr("class","none"!=b.obj.style.display?"expanded":"collapsed").mousedown({uid:b.uid},function(a){return f.expand_message_row(a,a.data.uid)}),b.unread_children=
0,l.push(b)),"none"==b.obj.style.display&&$(b.obj).show())}h=h.nextSibling}for(b=0;b<l.length;b++)this.set_unread_children(l[b].uid),this.set_flagged_children(l[b].uid);return e};this.delete_excessive_thread_rows=function(){for(var a=this.message_list.rows,b=this.message_list.tbody.firstChild,d=this.env.pagesize+1;b;)1==b.nodeType&&(r=a[b.uid])&&(!r.depth&&d&&d--,d||this.message_list.remove_row(b.uid)),b=b.nextSibling};this.set_message_icon=function(a){var b="",d=this.message_list.rows[a];if(!d)return!1;
...
b+=this.get_label("replied")+" "),d.forwarded&&(a+=" forwarded",b+=this.get_label("forwarded")+" "),$(d.msgicon).attr("class",a).attr("title",b));d.flagicon&&(a=d.flagged?"flagged":"unflagged",b=this.get_label(a),$(d.flagicon).attr("class",a).attr("aria-label",b).attr("title",b))};this.set_message_status=function(a,b,d){var e=this.message_list.rows[a];if(!e)return!1;"unread"==b?e.unread!=d&&this.update_thread_root(a,d?"unread":"read"):"flagged"==b&&this.update_thread_root(a,d?"flagged":"unflagged");
-1<$.inArray(b,["unread","deleted","replied","forwarded","flagged"])&&(e[b]=d)};this.set_message=function(a,b,d){var e=this.message_list&&this.message_list.rows[a];if(!e)return!1;b&&this.set_message_status(a,b,d);if(-1<$.inArray(b,["unread","deleted","flagged"]))$(e.obj)[e[b]?"addClass":"removeClass"](b);this.set_unread_children(a);this.set_message_icon(a)};this.set_unread_children=function(a){a=this.message_list.rows[a];if(!a.parent_uid){var b=!a.unread&&a.unread_children&&!a.expanded;$(a.obj)[b?
"addClass":"removeClass"]("unroot")}};this.set_flagged_children=function(a){a=this.message_list.rows[a];if(!a.parent_uid){var b=a.flagged_children&&!a.expanded;$(a.obj)[b?"addClass":"removeClass"]("flaggedroot")}};this.copy_messages=function(a,b){if(a&&"object"===typeof a)a=a.id;else if(!a)return this.folder_selector(b,function(a){f.command("copy",a)});if(a&&a!=this.env.mailbox){var d=this.selection_post_data({_target_mbox:a});d._uid&&this.http_post("copy",d,this.display_message(this.get_label("copyingmessage"),
"loading"))}};this.move_messages=function(a,b){if(a&&"object"===typeof a)a=a.id;else if(!a)return this.folder_selector(b,function(a){f.command("move",a)});if(a&&(a!=this.env.mailbox||this.is_multifolder_listing())){var d=!1,e=this.selection_post_data({_target_mbox:a});e._uid&&("show"==this.env.action?d=this.set_busy(!0,"movingmessage"):this.show_contentframe(!1),this.enable_command(this.env.message_commands,!1),this.with_selected_messages("move",e,d))}};this.delete_messages=function(a){var b=this.message_list,
...
"insert-response","save-response",!1);f.triggerEvent("compose-encrypted",{active:!0});f.env.attachments&&!$.isEmptyObject(f.env.attachments)&&(alert(f.get_label("encryptnoattachments")),$.each(f.env.attachments,function(a,b){f.remove_from_attachment_list(a)}))},function(a){console.error(a);console.log(b)}))};this.mailvelope_submit_messageform=function(a,b){var d=[];$.each(["to","cc","bcc"],function(a,b){for(var e,g=$.trim($('[name="_'+b+'"]').val());g.length&&rcube_check_email(g,!0);)e=RegExp.$2,
d.push(e),g=g.substr(g.indexOf(e)+e.length+1).replace(/^\s*,\s*/,"")});var e=0<d.length;f.mailvelope_keyring.validKeyForAddress(d).then(function(g){var h=[];$.each(g,function(a,b){!1===b&&(e=!1,h.push(a))});if(!e&&h.length)return f.simple_dialog(f.get_label("nopubkeyfor").replace("$email",h.join(", "))+"<p>"+f.get_label("searchpubkeyservers")+"</p>","encryptedsendialog",function(){f.mailvelope_search_pubkeys(h,function(){return!0})},{button:"search"}),!1;if(!e)return d.length||(alert(f.get_label("norecipientwarning")),
$("[name='_to']").focus()),!1;var k=[],l=f.env.identities[$("[name='_from'] option:selected").val()];$.each(f.env.identities,function(a,b){k.push(b.email)});f.mailvelope_keyring.validKeyForAddress(k).then(function(e){valid_sender=null;$.each(e,function(a,b){if(!1!==b&&(valid_sender=a,valid_sender==l))return!1});if(!valid_sender&&!confirm(f.get_label("nopubkeyforsender")))return!1;d.push(valid_sender);f.mailvelope_editor.encrypt(d).then(function(d){var e=f.gui_objects.messageform,g=$("[name='_pgpmime']",
e),h=f.set_busy(!0,a||b?"savingmessage":"sendingmessage");e.target="savetarget";e._draft.value=a?"1":"";e.action=f.add_url(e.action,"_unlock",h);e.action=f.add_url(e.action,"_framed",1);b&&(e.action=f.add_url(e.action,"_saveonly",1));g.length||(g=$('<input type="hidden" name="_pgpmime">').appendTo(e));g.val(d);e.submit()},function(a){console.log(a)})},function(a){console.error(a)})},function(a){console.error(a)});return!1};this.mailvelope_display_container=function(a,b,d,e){var g=function(b){$(a+
" > iframe").remove();f.hide_message(e);f.display_message(b.message,"error")};mailvelope.createDisplayContainer(a,b,d,{showExternalContent:this.env.safemode}).then(function(b){if(b.error&&b.error.message)return g(b.error);f.hide_message(e);$(a).addClass("mailvelope").children().not("iframe").hide();f.env.pgp_mime_part&&$("#attach"+f.env.pgp_mime_part).remove();setTimeout(function(){$(window).resize()},10)},g)};this.mailvelope_search_pubkeys=function(a,b,d){var e=[],g=new PublicKey,h=f.display_message(f.get_label("loading"),
"loading");$.each(a,function(a,b){var d=$.Deferred();g.search(b,function(a,e){null!==e?d.resolve([b]):d.resolve([b].concat(a))});e.push(d)});$.when.apply($,e).then(function(){var a=[],e=[];$.each(arguments,function(b,d){var g=d.shift();d.length?e=e.concat(d):a.push(g)});f.hide_message(h);b(!0);e.length&&f.mailvelope_key_import_dialog(e,d);a.length&&f.display_message(f.get_label("nopubkeyfor").replace("$email",a.join(", ")),"warning")}).fail(function(){console.error("Pubkey lookup failed with",arguments);
f.hide_message(h);f.display_message("pubkeysearcherror","error");b(!1)})};this.mailvelope_key_import_dialog=function(a,b){var d=$("<div>").addClass("listing pgpkeyimport");$.each(a,function(a,b){var e=$("<div>").addClass("key");b.revoked&&e.addClass("revoked");b.disabled&&e.addClass("disabled");b.expired&&e.addClass("expired");e.append($("<label>").addClass("keyid").text(f.get_label("keyid")));e.append($("<a>").text(b.keyid.substr(-8).toUpperCase()).attr("href",b.info).attr("target","_blank").attr("tabindex",
"-1"));e.append($("<label>").addClass("keylen").text(f.get_label("keylength")));e.append($("<span>").text(b.keylen));b.expirationdate&&(e.append($("<label>").addClass("keyexpired").text(f.get_label("keyexpired"))),e.append($("<span>").text((new Date(1E3*b.expirationdate)).toDateString())));b.revoked&&e.append($("<span>").addClass("keyrevoked").text(f.get_label("keyrevoked")));var g=$("<ul>").addClass("uids");$.each(b.uids,function(a,b){var d=$("<li>").addClass("uid");b.revoked&&d.addClass("revoked");
b.disabled&&d.addClass("disabled");b.expired&&d.addClass("expired");g.append(d.text(b.uid))});e.append(g);e.append($("<input>").attr("type","button").attr("rel",b.keyid).attr("value",f.get_label("import")).addClass("button importkey").prop("disabled",b.revoked||b.disabled||b.expired));d.append(e)});f.show_popup_dialog($("<div>").append($("<p>").html(f.get_label("encryptpubkeysfound"))).append(d),f.get_label("importpubkeys"),[{text:f.get_label("close"),click:function(){(f.is_framed()?parent.$:$)(this).dialog("close")}}]);
d.on("click","input.button.importkey",function(){var a=$(this),d=a.attr("rel"),h=new PublicKey,k=f.display_message(f.get_label("loading"),"loading");h.get(d,function(e,g){f.hide_message(k);g?f.display_message(f.get_label("keyservererror"),"error"):b?b(e):f.mailvelope_keyring.importPublicKey(e).then(function(b){"REJECTED"!==b&&(b=d.substr(-8).toUpperCase(),a.closest(".key").fadeOut(),f.display_message(f.get_label("keyimportsuccess").replace("$key",b),"confirmation"))},function(a){console.log(a)})})})};
...
this.env.mailbox==this.env.junk_mailbox||this.env.mailbox.startsWith(this.env.trash_mailbox+this.env.delimiter)||this.env.mailbox.startsWith(this.env.junk_mailbox+this.env.delimiter))};this.mark_all_read=function(a,b){var d,e,g=[];e=this.message_list;var h=a||this.env.mailbox,k={_uid:"*",_flag:"read",_mbox:h,_folders:b};if("string"!=typeof b){d=this.mark_all_read_state(h);if(!d)return;if(1<d){$.each({cur:1,sub:2,all:4},function(a,b){var e=$("<label>").attr("style","display:block; line-height:22px"),
h=$("<span>").text(f.get_label("folders-"+a)),k=$("<input>").attr({type:"radio",value:a,name:"mode"});d&b||(e.attr("class","disabled"),k.attr("disabled",!0));g.push(e.append(k).append(h))});e=$("<div>").append(g);$("input:not([disabled]):first",e).attr("checked",!0);this.show_popup_dialog(e,this.get_label("markallread"),[{"class":"mainaction",text:this.get_label("mark"),click:function(){f.mark_all_read(h,$("input:checked",this).val());$(this).dialog("close")}},{text:this.get_label("cancel"),click:function(){$(this).dialog("close")}}]);
return}k._folders="cur"}$.each(e?e.rows:[],function(a,d){if(d.unread){var e=f.env.messages[a].mbox;("all"==b||e==f.env.mailbox||"sub"==b&&e.startsWith(f.env.mailbox+f.env.delimiter))&&f.set_message(a,"unread",!1)}});this.http_post("mark",k,this.display_message(this.get_label("markingmessage"),"loading"))};this.mark_all_read_state=function(a){var b=0,d=this.treelist.get_item(a||this.env.mailbox);a=$(d).is(".unread")?1:0;var d=$("li.unread",d).length,e=$("li.unread",f.gui_objects.folderlist).length,
...
function(){if(!this.gui_objects.messageform)return!1;var a,b,d=$("[name='_from']"),e=$("[name='_to']"),g=$("input[name='_subject']"),h=$("[name='_message']").get(0),f="1"==$("input[name='_is_html']").val(),l=["cc","bcc","replyto","followupto"],m,n=this.opener();n&&"compose"==n.env.action&&(setTimeout(function(){1<opener.history.length?opener.history.back():n.redirect(n.get_task_url("mail"))},100),this.env.opened_extwin=!0);0<this.env.autocomplete_threads&&(m={threads:this.env.autocomplete_threads,
sources:this.env.autocomplete_sources});this.init_address_input_events(e,m);for(a in l)this.init_address_input_events($("[name='_"+l[a]+"']"),m);f||(a=this.env.top_posting&&this.env.compose_mode?0:h.value.length,"select-one"==d.prop("type")&&(this.set_caret_pos(h,0),this.change_identity(d[0])),this.set_caret_pos(h,a),a&&$(h).scrollTop(h.scrollHeight));this.env.save_localstorage&&this.compose_restore_dialog(0,f);""==e.val()?b=e:""==g.val()?b=g:h&&(b=h);$(b).filter(":visible").focus();this.env.compose_focus_elem=
document.activeElement;this.compose_field_hash(!0);this.auto_save_start()};this.compose_restore_dialog=function(a,b){var d,e,g,h=this.local_storage_get_item("compose.index",[]),k=function(a){++a<h.length&&f.compose_restore_dialog(a,b)};for(d=a||0;d<h.length;d++)if(e=h[d],g=this.local_storage_get_item("compose."+e,null,!0)){if(g.changed&&e==this.env.compose_id){this.restore_compose_form(e,b);break}if(!(this.env.draft_id&&g.draft_id&&g.draft_id!=this.env.draft_id||this.env.reply_msgid&&g.reply_msgid!=
this.env.reply_msgid)&&g.changed&&g.session!=this.env.session_id){this.show_popup_dialog(this.get_label("restoresavedcomposedata").replace("$date",(new Date(g.changed)).toLocaleString()).replace("$subject",g._subject).replace(/\n/g,"<br/>"),this.get_label("restoremessage"),[{text:this.get_label("restore"),"class":"mainaction",click:function(){f.restore_compose_form(e,b);f.remove_compose_data(e);f.save_compose_form_local();$(this).dialog("close")}},{text:this.get_label("delete"),"class":"delete",click:function(){f.remove_compose_data(e);
$(this).dialog("close");k(d)}},{text:this.get_label("ignore"),click:function(){$(this).dialog("close");k(d)}}]);break}}};this.init_address_input_events=function(a,b){this.env.recipients_delimiter=this.env.recipients_separator+" ";a.keydown(function(a){return f.ksearch_keydown(a,this,b)}).attr({autocomplete:"off","aria-autocomplete":"list","aria-expanded":"false",role:"combobox"});$(document).on("click",function(){f.ksearch_hide()})};this.submit_messageform=function(a,b){var d=this.gui_objects.messageform;
if(d){if(!b&&this.env.is_sent)return this.simple_dialog(this.get_label("messageissent"),"",function(){f.submit_messageform(!1,!0);return!0});if(this.mailvelope_editor)return this.mailvelope_submit_messageform(a,b);var e=this.set_busy(!0,a||b?"savingmessage":"sendingmessage"),g=this.spellcheck_lang(),h=[];$("li",this.gui_objects.attachmentlist).each(function(){h.push(this.id.replace(/^rcmfile/,""))});$('input[name="_attachments"]',d).val(h.join());d.target="savetarget";d._draft.value=a?"1":"";d.action=
this.add_url(d.action,"_unlock",e);d.action=this.add_url(d.action,"_lang",g);d.action=this.add_url(d.action,"_framed",1);b&&(d.action=this.add_url(d.action,"_saveonly",1));this.submit_timer=setTimeout(function(){f.set_busy(!1,null,e);f.display_message(f.get_label("requesttimedout"),"error")},1E3*this.env.request_timeout);d.submit()}};this.compose_recipient_select=function(a){var b,d,e=0;for(d=0;d<a.selection.length;d++)b=a.selection[d],this.env.contactdata[b]&&e++;this.enable_command("add-recipient",
e)};this.compose_add_recipient=function(a){a||(a=$(this.env.focused_field).filter(":visible"),a=a.length?a.attr("id").replace("_",""):"to");var b=[],d=$("#_"+a),e=this.env.recipients_delimiter;if(this.contact_list&&this.contact_list.selection.length)for(var g,f=0;f<this.contact_list.selection.length;f++)if((g=this.contact_list.selection[f])&&this.env.contactdata[g]&&(b.push(this.env.contactdata[g]),"E"==g.charAt(0)&&0>this.env.contactdata[g].indexOf("@")&&d.length)){var k=g.substr(1);this.group2expand[k]=
{name:this.env.contactdata[g],input:d.get(0)};this.http_request("group-expand",{_source:this.env.source,_gid:k},!1)}b.length&&d.length&&(g=d.val(),f=new RegExp(RegExp.escape(e)+"\\s*$"),g&&!f.test(g)&&(g+=e+" "),d.val(g+b.join(e+" ")+e+" ").change(),this.triggerEvent("add-recipient",{field:a,recipients:b}));return b.length};this.check_compose_input=function(a,b){var d,e,g,h=this.env.max_disclosed_recipients,k=$("[name='_to']"),l=$("[name='_cc']"),m=$("[name='_bcc']"),n=$("[name='_from']"),p=$("[name='_subject']"),
q=function(a){a=$.map(a,function(a){a=$.trim(a.val());return a.length?a:null});return a.join(",").replace(/^[\s,;]+/,"").replace(/[\s,;]+$/,"")};if("text"==n.prop("type")&&!rcube_check_email(n.val(),!0))return alert(this.get_label("nosenderwarning")),n.focus(),!1;e=q([k,l,m]);if(!b&&!rcube_check_email(e,!0))return alert(this.get_label("norecipientwarning")),k.focus(),!1;for(d in this.env.attachments)if("object"===typeof this.env.attachments[d]&&!this.env.attachments[d].complete)return alert(this.get_label("notuploadedwarning")),
!1;if(h&&!b&&!this.env.disclosed_recipients_warned&&rcube_check_email(e=q([k,l]),!0,!0)>h){var t=function(b){b&&(b=m.val(),m.val((b?b+", ":"")+e).change(),k.val("").change(),l.val("").change());g.dialog("close");f.check_compose_input(a,!0)};g=this.show_popup_dialog(this.get_label("disclosedrecipwarning"),this.get_label("disclosedreciptitle"),[{text:this.get_label("sendmessage"),click:function(){t(!1)},"class":"mainaction"},{text:this.get_label("bccinstead"),click:function(){t(!0)}},{text:this.get_label("cancel"),
click:function(){g.dialog("close")}}],{dialogClass:"warning"});this.env.disclosed_recipients_warned=!0;return!1}if(!this.env.nosubject_warned&&""==p.val()){var u=$("<input>").attr({type:"text",size:40});d=$('<div class="prompt">').append($('<div class="message">').text(this.get_label("nosubjectwarning"))).append(u);t=function(){p.val(u.val());g.dialog("close");f.command(a,{nocheck:!0})};g=this.show_popup_dialog(d,this.get_label("nosubjecttitle"),[{text:this.get_label("sendmessage"),click:function(){t()},
...
this.get_label("qrcode"),b=[{text:this.get_label("close"),"class":"mainaction",click:function(){(f.is_framed()?parent.$:$)(this).dialog("destroy")}}],d=new Image(300,300);d.src=this.url("addressbook/qrcode",{_source:this.env.source,_cid:this.env.cid});return this.show_popup_dialog(d,a,b,{width:310,height:410})};this.section_select=function(a){var b;b=a.get_single_selection();a=window;var d={_action:"edit-prefs",_section:b};if(b){if(b=this.get_frame_window(this.env.contentframe))d._framed=1,a=b;this.location_href(d,
...
this.env.unread_counts[a]=b;this.set_unread_count_display(a,d);e?this.mark_folder(a,e,"",!0):b||this.unmark_folder(a,"recent","",!0);this.mark_all_read_state()};this.set_unread_count_display=function(a,b){var d,e,g,f,k;if(g=this.get_folder_li(a,"",!0)){f=this.env.unread_counts[a]?this.env.unread_counts[a]:0;e=$(g).children("a").eq(0);d=e.children("span.unreadcount");!d.length&&f&&(d=$("<span>").addClass("unreadcount").appendTo(e));e=0;if((k=g.getElementsByTagName("div")[0])&&k.className.match(/collapsed/))for(var l in this.env.unread_counts)l.startsWith(a+
this.env.delimiter)&&(e+=this.env.unread_counts[l]);f&&d.length?d.html(this.env.unreadwrap.replace(/%[sd]/,f)):d.length&&d.remove();d=new RegExp(RegExp.escape(this.env.delimiter)+"[^"+RegExp.escape(this.env.delimiter)+"]+$");a.match(d)&&this.set_unread_count_display(a.replace(d,""),!1);0<f+e?$(g).addClass("unread"):$(g).removeClass("unread")}d=/^\([0-9]+\)\s+/i;b&&document.title&&(g=String(document.title),f=f&&g.match(d)?g.replace(d,"("+f+") "):f?"("+f+") "+g:g.replace(d,""),this.set_pagetitle(f))};
...
b.enabledPlugin)return 1;if("ActiveXObject"in window){try{return b=new ActiveXObject("AcroPDF.PDF"),1}catch(h){}try{return b=new ActiveXObject("PDF.PdfCtrl"),1}catch(h){}}for(a=0;a<e;a++)if(b=d[a],"String"===typeof b){if(g.test(b))return 1}else if(b.name&&g.test(b.name))return 1;window.setTimeout(function(){$("<object>").attr({data:f.assets_path("program/resources/dummy.pdf"),type:"application/pdf",style:'position: "absolute"; top: -1000px; height: 1px; width: 1px'}).on("load error",function(a){f.env.browser_capabilities.pdf=
